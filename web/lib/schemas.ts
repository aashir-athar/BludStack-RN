// lib/schemas.ts - zod schemas + inferred types for every form, ported from the
// app. Client validation mirrors the server; the server stays authoritative.
// The donor age gate (18-65) is enforced here and in the backend RPC.
import { z } from "zod";
import { BLOOD_GROUPS, GENDER_OPTIONS, URGENCY_LEVELS } from "./blood-data";
import { computeAge, DONOR_MIN_AGE, DONOR_MAX_AGE } from "./age";
